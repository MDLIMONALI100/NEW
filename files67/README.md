...
├── contact-scene.js            The 3D scene beside the contact form (Three.js)
...
## The 3D scene beside the contact form

The empty space next to the contact form now has a small Three.js scene (a rotating torus knot with a couple of orbiting accent shapes) in the same terracotta palette as the hero. It respects "reduce motion" settings and only starts animating once it scrolls into view, same as the rest of the site.
